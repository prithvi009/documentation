---
title: How It Works
description: 'Understanding TracksSource attribution and identity resolution'
---
...
When a visitor lands on your website, TracksSource captures:
...
When TracksSource captures an event, it's automatically forwarded to ad platforms:
...
sequenceDiagram
    ...
    participant S as TracksSource SDK
...
TracksSource is designed for privacy:
...
<CardGroup cols={2}>
  ...
  <Card title="Data Ownership" icon="database">
    Self-host for complete control. Your data, your servers.
  </Card>
