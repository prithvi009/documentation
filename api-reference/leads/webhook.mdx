...
The request body can be **any JSON payload** from a form provider. TrackSource automatically detects the source and extracts data.
...
<ParamField body="anonymous_id" type="string">
  Visitor ID from TrackSource SDK
</ParamField>
