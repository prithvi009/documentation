...
## How TracksSource CAPI Works

```
┌──────────────────────────────────────────────────────────────────┐
│                        Your Website                               │
│  ┌──────────────────┐      ┌──────────────────┐                  │
│  │ TracksSource SDK │      │  Facebook Pixel  │                  │
...
TracksSource sends these events to CAPI:

| TracksSource Event | Facebook Event | Parameters |
|-------------------|----------------|------------|
...
TracksSource automatically deduplicates events:
...
3. Add to your TracksSource config
