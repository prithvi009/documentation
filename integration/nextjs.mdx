---
title: 'Next.js Integration - Marketing Attribution for Next.js'
sidebarTitle: 'Next.js'
description: 'Add marketing attribution to Next.js 13+ with App Router support. Server components, automatic page tracking, and conversion attribution for Next.js applications.'
icon: 'n'
og:title: 'TrackSource Next.js SDK | Marketing Attribution'
og:description: 'Install TrackSource in your Next.js app. Works with App Router and Pages Router. Automatic tracking with SSR support.'
---
