...
description: 'TracksSource setup for Next.js applications'
---
...
```tsx
// components/providers/TracksSourceProvider.tsx
'use client';

import { TracksSourceProvider as TSProvider } from '@tracksource/react';

export function TracksSourceProvider({ children }: { children: React.ReactNode }) {
  return (
    <TSProvider
...
```tsx
// app/layout.tsx
import { TracksSourceProvider } from '@/components/providers/TracksSourceProvider';
...
import { TracksSourceProvider, useTracksSource } from '@tracksource/react';
...
TracksSource works alongside Vercel Analytics:
