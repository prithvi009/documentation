---
title: 'Server-Side Tracking - Backend Event Attribution'
sidebarTitle: 'Server-Side'
description: 'Track conversions and events from your backend. Server-side tracking for purchases, subscriptions, and webhook events. Works with any programming language via REST API.'
icon: 'server'
og:title: 'Server-Side Tracking | TrackSource API'
og:description: 'Track backend events and conversions. Server-side attribution that works with ad blockers. REST API examples in Node.js, Python, PHP, and more.'
---
...
Receive events from your payment provider and forward to TrackSource:
